...
import { FaBalanceScale, FaUserTie, FaFileContract, FaShieldAlt, FaPhone, FaCalendarCheck, FaGavel, FaHandshake, FaClipboardCheck, FaCheckCircle, FaArrowRight } from 'react-icons/fa';
        ...
        <section className="relative py-32">
          <div className="container mx-auto px-6 lg:px-12">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                {/* Badge */}
                <div className="inline-block px-3 py-1 bg-white/5 border border-white/20 rounded-full mb-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <button
                    onClick={() => openLeadCapture('legal_hero')}
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
              <button
                onClick={() => openLeadCapture('legal_cta')}
                className="flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white text-lg font-semibold rounded-xl transition-all shadow-lg shadow-cyan-500/25"
              >
                <FaCalendarCheck />
                Schedule Legal Demo
