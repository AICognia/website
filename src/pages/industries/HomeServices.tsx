...
import { FaHome, FaWrench, FaCalendarCheck, FaPhone, FaClipboardList, FaTools, FaHandshake, FaCheckCircle, FaPlug, FaSnowflake, FaFaucet, FaLeaf } from 'react-icons/fa';
