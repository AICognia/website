...
import { FaCar, FaWrench, FaCalendarCheck, FaCarSide, FaPhone, FaClipboardList, FaTools, FaHandshake, FaMapMarkerAlt, FaCheckCircle, FaArrowRight } from 'react-icons/fa';
          ...
          <div className="container mx-auto px-6 lg:px-12">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button
                  onClick={() => openLeadCapture('automotive_hero')}
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
              <button
                onClick={() => openLeadCapture('automotive_cta')}
                className="flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white text-lg font-semibold rounded-xl transition-all shadow-lg shadow-cyan-500/25"
              >
                <FaCalendarCheck />
                Schedule Automotive Demo
