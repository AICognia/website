          ...
          >
            ...
            >
              <div className="flex items-center gap-4">
                <div className="h-[1px] w-24 bg-gradient-to-r from-transparent to-cyan-500" />
                ...
                <div className="h-[1px] w-24 bg-gradient-to-l from-transparent to-cyan-500" />
              </div>
            </motion.div>
                ...
                <section className="mt-12 pt-8 border-t border-gray-700">
                  <div className="text-center">
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-500/30 hover:border-cyan-400/50 text-cyan-400 font-semibold rounded-xl transition-all duration-300 hover:scale-105"
                    >
                      <FaEnvelope />
