  ...
  if (variant === 'hero') {
    return (
      <div className="relative min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-blue-600/5 via-blue-500/5 to-indigo-500/5 animate-gradient" />
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/95 backdrop-blur-xl">
      ...
      >
        ...
        <div className="relative w-24 h-24 mx-auto mb-8">
          <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl animate-spin-slow" />
