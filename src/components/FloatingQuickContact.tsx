      ...
      <div className="floating-contact fixed z-40">
        <AnimatePresence>
          {isOpen && (
            ...
            >
              <div className="bg-gradient-to-r from-primary/10 to-purple-500/10 px-4 py-3 border-b border-white/10">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="p-1.5 hover:bg-transparent/10 rounded-lg transition-colors"
                  >
                ...
                {!showCallbackForm ? (
                  <div className="space-y-2">
                    {contactOptions.map((option, index) => {
                      ...
                      return (
                        <Component
                          ...
                          className="flex items-center gap-3 p-3 bg-white/5 hover:bg-transparent/10 border border-white/10 rounded-xl transition-all group w-full text-left"
                        >
                    ...
                    <button
                      ...
                      className="w-full flex items-center gap-3 p-3 bg-white/5 hover:bg-transparent/10 border border-dashed border-white/20 rounded-xl transition-all group"
                    >
                      <div className="w-10 h-10 rounded-lg bg-transparent/10 flex items-center justify-center">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="relative w-14 h-14 bg-gradient-to-r from-primary to-primary-dark rounded-full shadow-lg shadow-primary/30 flex items-center justify-center"
        >
