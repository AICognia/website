...
const ExitIntentPopup: React.FC<ExitIntentPopupProps> = ({ onEmailCapture }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log('Exit popup submission:', { email, offer: selectedOffer });
        ...
        >
          ...
          >
            ...
            {!isSubmitted ? (
              <>
                {/* Header */}
                <div className="bg-gradient-to-r from-cyan-500/20 via-purple-500/20 to-cyan-500/20 px-6 py-8 text-center">
                  <motion.div
                    initial={{ scale: 0 }}
                    animate={{ scale: 1 }}
                      ...
                      return (
                        ...
                        >
                          <div className={`w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 ${
                            isSelected ? `bg-${offer.color}-500/20` : 'bg-white/10'
                          }`}>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-12 pr-4 py-3.5 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-cyan-500/50"
                        required
                      />
                    </div>
                    <button
