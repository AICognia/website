...
import { FaShieldAlt, FaFilter, FaChartLine, FaCheckCircle, FaPhone, FaUserCheck, FaClipboardCheck, FaBullseye, FaCalendarCheck, FaArrowRight } from 'react-icons/fa';
              ...
              >
                <div className="relative z-10 text-left">
                  ...
                  <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif font-normal leading-tight mb-4 md:mb-8">
                    Lead Qualification
                    <br />
                    <span className="text-transparent bg-clip-text bg-gradient-to-br from-blue-600 to-blue-400">Screen and Route Prospects</span>
                  </h1>

                  <p className="text-base md:text-lg lg:text-xl text-slate-600 max-w-2xl mb-6 md:mb-12">
                    Automatically qualify leads, score prospects, and route qualified opportunities to your sales team.
                    Focus your team's time on ready-to-buy customers with intelligent AI-powered qualification.
                  </p>
                  ...
                  <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 md:gap-6">
                    ...
                    <a
                      ...
                      className="group h-12 md:h-14 px-6 md:px-10 rounded-lg bg-slate-50/80 border border-slate-200 text-slate-600 font-semibold transition-all flex items-center justify-center gap-2 md:gap-3 text-base md:text-lg hover:bg-white hover:border-blue-200 active:scale-[0.98] w-full sm:w-auto"
                    >
                      <FaPhone className="text-xs md:text-sm group-hover:text-blue-600 transition-colors" />
                      <span className="group-hover:text-blue-600 transition-colors">Talk to Sales</span>
                    </a>
                  </div>
                </div>
                ...
                <div className="relative z-10 mt-6 md:mt-8 grid grid-cols-3 gap-4 md:gap-8">
                  <div className="text-center">
                    <div className="text-xl md:text-2xl lg:text-3xl font-bold text-blue-600">85%</div>
                    <div className="text-xs md:text-sm text-slate-500">Time Saved</div>
                  </div>
                  <div className="text-center">
                    <div className="text-xl md:text-2xl lg:text-3xl font-bold text-blue-600">3x</div>
                    <div className="text-xs md:text-sm text-slate-500">Conversion Rate</div>
                  </div>
                  <div className="text-center">
              ...
              >
                <div className="space-y-4 md:space-y-6">
                  <div className="flex items-start gap-3 md:gap-4">
                    ...
                    <div>
                      <h3 className="text-base md:text-lg font-semibold mb-1 md:mb-2">Smart Scoring</h3>
                      <p className="text-sm md:text-base text-slate-600">AI-powered lead scoring based on behavior, demographics, and intent signals.</p>
                    </div>
                  </div>

                  <div className="flex items-start gap-3 md:gap-4">
                    <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-green-100 flex items-center justify-center flex-shrink-0">
                      <FaFilter className="text-green-600 text-lg md:text-xl" />
                    </div>
                    <div>
                      <h3 className="text-base md:text-lg font-semibold mb-1 md:mb-2">Auto Filtering</h3>
                      <p className="text-sm md:text-base text-slate-600">Automatically filter out unqualified leads and route hot prospects instantly.</p>
                    </div>
                  </div>

                  <div className="flex items-start gap-3 md:gap-4">
                    <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-purple-100 flex items-center justify-center flex-shrink-0">
                      <FaChartLine className="text-purple-600 text-lg md:text-xl" />
                    </div>
                    <div>
                      <h3 className="text-base md:text-lg font-semibold mb-1 md:mb-2">Real-time Analytics</h3>
                      <p className="text-sm md:text-base text-slate-600">Track qualification metrics and optimize your sales funnel performance.</p>
                    </div>
                  </div>
                </div>
              </motion.div>
              ...
              <TechCard key={index}>
                <div className="text-center p-2 md:p-4">
                  <div className="w-12 h-12 md:w-14 md:h-14 mx-auto mb-3 md:mb-4 bg-gray-50 border border-gray-200 rounded-xl flex items-center justify-center">
                    <feature.icon className="text-xl md:text-2xl text-blue-600" />
                  </div>
